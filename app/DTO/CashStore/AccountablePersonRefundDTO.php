...
class AccountablePersonRefundDTO
{
    public function __construct(public string $date, public int $organization_id, public int $cash_register_id, public float $sum,
                                public int $employee_id, public string $basis, public ?string $comment, public ?string $type, public int $operation_type_id, public ?string $sender, public ?string $recipient)
    {
    }
