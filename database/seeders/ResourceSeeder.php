    ...
    public function run(): void
    {
        Resource::query()->upsert(
            [
                ...
                ['name' => 'currency', 'parent_id' => 1, 'type' => ResourceTypes::AdminPanel->value, 'ru_name' => 'Валюта'],
                ...
                ['name' => 'sellingGoods', 'parent_id' => null, 'type' => ResourceTypes::PodSystem->value, 'ru_name' => 'Продажа'],
